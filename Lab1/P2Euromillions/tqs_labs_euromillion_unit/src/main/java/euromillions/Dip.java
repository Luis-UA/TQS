...
public class Dip {
    ...
    static final int NSTARS = 2; //number of stars
    static final int NNUMBERS = 5; //number of numbers
    static final int NUMBER_UPPERBOUND = 50; //the highest value a number can have
    static final int STARS_UPPERBOUND = 10;  //the highest value a star can have
    ...
    public static Dip generateRandomDip() {
        ...
        for (int i = 0; i < 5; ) {
            int candidate = generator.nextInt(NUMBER_UPPERBOUND-1) + 1;
        ...
        for (int i = 0; i < 2; ) {
            int candidate = generator.nextInt(STARS_UPPERBOUND-1) + 1;
