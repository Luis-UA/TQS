...
public class DipTest {
    ...
    public void testConstructorFromBadArrays() {
        ...
        assertThrows(IllegalArgumentException.class, ()->new Dip(new int[]{10, 20, 30, 40, 50}, new int[]{1,4,6}));
        assertThrows(IllegalArgumentException.class, ()->new Dip(new int[]{10, 20, 30, 40, 50, 60}, new int[]{1,4}));
